...
namespace AvMonitor.Models
{
    public class TaskModel
    {
        ...
        public string? UserName { get; set; } = "NIKITA228"; //до реализации авторизации тут будет этот костыль, сор€н, если из-за этого буду ошибки ^-^
        ...
        [Display(Name = "√рафик выполнени€ (формат crontab)")]
        [Required]
